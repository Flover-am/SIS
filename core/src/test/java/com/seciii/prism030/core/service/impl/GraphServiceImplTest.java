...
public class GraphServiceImplTest {
    ...
    void addEntityNodeTest() {
        Assertions.assertDoesNotThrow(() -> graphService.addEntityNode(1L, "科比"));
    }

    @Test
    void getGraphTest() {
        Assertions.assertThrows(GraphException.class, () -> graphService.getGraph(100L));
        Assertions.assertDoesNotThrow(() -> graphService.getGraph(10L));
    }

    @Test
    void analyzeNewsTest() {
        Assertions.assertThrows(GraphException.class, () -> graphService.analyzeNews(100L));
        Assertions.assertThrows(GraphException.class, () -> graphService.analyzeNews(11L));
    }

    @Test
    void addEntityRelationshipTest() {
        Assertions.assertThrows(NoSuchElementException.class, () -> graphService.addEntityRelationship(1L, 2L, "乘坐"));
    ...
    void addNewsEntitiesTest(){
        ...
        Assertions.assertDoesNotThrow(()->graphService.addNewsEntities(10L,new ArrayList<>(){{add(NewsEntityRelationshipDTO.builder().build());}}));
    }
    @Test
