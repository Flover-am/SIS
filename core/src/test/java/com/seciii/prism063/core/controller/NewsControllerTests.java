    ...
    public void initTestObjecets(){
        ...
        for(int i=0;i<10;i++){
            fakeNewsList.add(NewsItemVO.builder()
                    ...
                    .sourceTime(LocalDateTime.parse("2024-03-04 00:01:0"+i, DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
                    .category("test"+i+"cat")
                    .build()
            );
        }
        fakeNewsVO=NewsVO.builder()
                ...
                .sourceTime(LocalDateTime.parse("2024-03-04 00:01:00", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")))
                .link("www.test.com")
                .sourceLink("www.testsource.com")
                .category("testcat")
